    ...
    public void get01(){
        ...
        response.
                ...
                body("meta.pagination.limit", equalTo(20),
                        ...
                        "data.name", hasItems("Krishnadasa Panicker", "Mandakini Khatri VM"));
        ...
        System.out.println(femaleList.size());//[female, female, ... , female]

        List<String> maleList = json.getList("data.findAll{it.gender=='male'}.id");
        System.out.println(maleList.size());//[male, male, ... , male]
